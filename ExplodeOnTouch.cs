using UnityEngine;
//------------------------------
    /*this is an attempt to make the fish (or any enemy) go flying in the opposite
    direction of impact when they come into contact with the bullet, ideas commented out
